...
// Asegúrate de que BASE_PATH y BASE_URL estén definidos en tu config.php
...
<aside class="sidebar">
    <div class="sidebar-top">
        ...
        <nav class="sidebar-nav">
            <a href="<?= BASE_URL ?>/index.php" class="<?= $paginaActual == 'agenda' ? 'activo' : '' ?>">
                <span class="material-symbols-outlined">box</span> Encargos
            </a>
            <a href="<?= BASE_URL ?>/index.php?page=clientes" class="<?= $paginaActual == 'clientes' ? 'activo' : '' ?>">
                <span class="material-symbols-outlined">group</span> Clientes
            </a>
            <a href="<?= BASE_URL ?>/index.php?page=pagos" class="<?= $paginaActual == 'pagos' ? 'activo' : '' ?>">
